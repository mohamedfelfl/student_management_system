                          ...
                          children: state.groups.map((g) {
                            return SizedBox(
                              ...
                              child: Card(
                                child: InkWell(
                                  onTap: () {
                                    context.router.push(GroupFormRoute(id: g['id'] as int));
                                  },
                                  ...
                                  child: Padding(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                          ...
                                          children: [
                                            ...
                                            PopupMenuButton<String>(
                                              itemBuilder: (BuildContext _) => <PopupMenuEntry<String>>[
                                                ...
                                                PopupMenuItem<String>(value: 'delete', child: Text(LocaleKeys.delete.tr())),
                                              ],
                                              onSelected: (String v) {
                                                if (v == 'edit') {
                                                  context.router.push(GroupFormRoute(id: g['id'] as int));
                                                } else {
                                                  context.read<GroupCubit>().deleteGroup(g['id'] as int);
                                                }
                                              },
                                            ),
                                          ],
                                        ...
                                        if (g['schedules'] != null && (g['schedules'] as List).isNotEmpty)
                                          Wrap(
                                            spacing: 8,
                                            runSpacing: 4,
                                            crossAxisAlignment: WrapCrossAlignment.center,
                                            children: [
                                              ...(g['schedules'] as List).map((s) {
                                                return Container(
                                                  ...
                                                  child: Row(
                                                    mainAxisSize: MainAxisSize.min,
                                                    children: [
                                                      Icon(Icons.calendar_today, size: 10, color: colorScheme.primary),
                                        ...
                                        Row(
                                          children: [
                                            const Spacer(),
                                            Chip(
                                              label: Text(LocaleKeys.students_count.tr(args: [(g['student_count'] ?? 0).toString()])),
